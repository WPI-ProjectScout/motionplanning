...
class BasicAgent(object):
    ...
    def __init__(self, vehicle, target_speed=50, opt_dict={}, map_inst=None, grp_inst=None):
        """
    ...
    def run_step(self, debug=False):
        ...
        #Car following behaviour for emergency
    ...
    def ignore_stop_signs(self, active=False):
...
class EmergencyAgent(BasicAgent):
    """
    EmergencyAgent
    """
    ...
    def run_step(self, debug=False):
        ...
        # 4: Normal behavior
            ...
            target_speed = min([
                self._behavior.max_speed,
                50 - self._behavior.speed_lim_dist])
            self._local_planner.set_speed(target_speed)
            control = self._local_planner.run_step(debug=debug)
